...
def check_guess(event=None):
    ...
    # Add subtle cheating chance
    cheat_chance = 0.15  # 15% of the time, match the user's guess
...
def end_game():
    ...
    tk.Label(frame_end, text="Session Ended", font=("Arial", 18), fg="#5cd3ff", bg="#111").pack(pady=20)
